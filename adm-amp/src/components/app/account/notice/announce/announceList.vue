<template>
	<div class="page-content">
		<div class="page-title show-menu">公告</div>
		<div class="content">
			<div class="message-list">
				<ol>
					...
					<li v-for="message in messages" :class="{actived: message.isRead == 0}">
						<span class="list-infor"><router-link :to="{name: 'adetail', params:{id: message.messageId}}" target="_blank">{{message.title}}</router-link></span>
