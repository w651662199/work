...
class Email {
	 ...
	 * @var string
	 */
	public static $user = "auto-digital";
	/**
	 * 认证密码（base64）
	 * @var string
	 */
	public static $password = "MSg4o,S#8lsS_D)'";
	/**
	 * 默认使用邮箱
	 * @var string
	 */
	public static $from = "auto-digital@gomeplus.com";
	/**
	 * 超时
	 * @var number
	 */
	...
	private function _send() {
		foreach($this->_commands as $pairs) {
			...
			if($code != 2 && $code != 3) {
				throw new Exception("邮件发送失败 &raquo; {$response}");
			}
		}
	}
